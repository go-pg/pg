...
var formatTests = []formatTest{
	...
	{q: "?", params: params{structv}, wanted: `'{"String":"string_value","Zeroable":"","Iface":"iface_value"}'`},
	...
	{q: "?zeroable", params: params{&StructFormatter{}}, wanted: `''`},
	{
		q:      "? ?string ?",
