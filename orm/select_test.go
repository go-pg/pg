...
var _ = Describe("Select Order", func() {
	orderTests := []orderTest{
        ...
        {"id collate icu asc nulls first", `"id" collate "icu" asc nulls first`},
        {"id collate icu asc nulls last", `"id" collate "icu" asc nulls last`},
        {"id collate icu desc nulls first", `"id" collate "icu" desc nulls first`},
        {"id collate icu desc nulls last", `"id" collate "icu" desc nulls last`},
		{"id ASC", `"id" ASC`},
		{"id DESC", `"id" DESC`},
		{"id ASC NULLS FIRST", `"id" ASC NULLS FIRST`},
		{"id DESC NULLS FIRST", `"id" DESC NULLS FIRST`},
